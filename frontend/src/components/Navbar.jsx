    ...
    <nav className="bg-gray-800 text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            {user && <Link to="/cart" className="hover:text-gray-300">Cart</Link>}
      ...
      {menuOpen && (
        <div className="md:hidden bg-gray-700 px-4 py-4 space-y-2">
          ...
          {user && <Link to="/cart" className="block hover:text-gray-300" onClick={() => setMenuOpen(false)}>Cart</Link>}
          {user && <Link to="/orders" className="block hover:text-gray-300" onClick={() => setMenuOpen(false)}>My Orders</Link>}
